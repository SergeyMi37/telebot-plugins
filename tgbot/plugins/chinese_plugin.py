...
if __name__ == "__main__":
    ...
    main()
# ```
# "Ты специалист по китайской лингвистики. Представь этимологию китайских иероглифов: 牛仔裤 Только общий смысл и номера радикалов. Четко и без рассуждений."

# Ты специалист по китайской лингвистики.
# Необходимо найди этимологию китайских иероглифов: 牛仔裤
# Только общий смысл и номера радикалов.
# Четко и без рассуждений выведи только список в формате:
# {Порядковый номер} {Иероглиф} {Номер радикала} {перевод английский} {перевод русский}
